    ...
    <div class="container-fluid my-2">
      <div class="row">
        <div class="col-lg-6 my-auto">
          ...
          <p class="py-lg-4">EDUWHEELS EDUCATION MANAGEMENT SYSTEM - SCHOOL / COLLEGE & UNIVERSITY (ERP)</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 py-5 ">
          ...
          <div class="pr-5">
            <p>Smart School Connect is a user-interactive, flexible, robust, easy-to-access and diversified School / College / University Management ERP platform, which can be embedded in every generation devices. It is a smart educational system, which enables every feature, functions and completes the daily needs of School, Colleges, Universities and Educational Institutions. <br>
            It provides different roles and functionality to every unique user with diversified perspective.</p>
          </div>
          <a href="about-us.php" class="btn btn-secondary">Know More</a>
        </div>
        <div class="col-lg-6" style="background:url(./assets/images/school.jpg)">
        </div>
      </div>
    </div>
  </section>
  ...
  <h1 class="text-center mb-5"> <b>our Courses</b> </h1>
   <p class="text-center "> <b>Vidyalay digitilizing  school management system is a comprehensive web application for educational institutions. 
   </b>
   </p>
   <p class="mb-5"><b>It is designed for better interaction between students, teachers, parents and management.</b></p>
    ...
    <div class="row">
      ...
      for ($i=0; $i < 12 ; $i++) { ?>
        ...
        <img src="./assets/images/img1.png" alt="" class="img-fluid">        
          ...
          <div class="card-body">
            <p class="card-text">
              <b> web design and development</b> <br>
